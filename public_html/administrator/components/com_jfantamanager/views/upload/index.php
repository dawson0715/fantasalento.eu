 ...
 *   $Id: index.php, v1.25 04/06/2008 17:19 Flava Clown $
...
function ScriviGiornata()

{

    $giornata=$_GET['gid'];

    $lista="<option value='$giornata' selected='selected'>Giornata $giornata</option>";

    for($i=$giornata-1;$i>0;$i--)

        $lista .= "<option value='$i'>Giornata $i</option>";

	 $lista .= "<option value='0'>Aggiorna giocatori</option>";
...

{
...

	{
		...
		echo "<img src=\"images/empty.gif\" width=\"16\" height=\"16\" border=\"0\">&nbsp;";
...
echo "        <a href=\"javascript:popupmail('$filename', '$directory')\">
             ...
             alt=\"$mess[68]\" width=\"16\" height=\"16\" border=\"0\"></a>";
...

{
    ...
    echo "		 					<img src=\"images/parent.gif\" width=\"16\" height=\"16\" align=\"absmiddle\" border=\"0\">\n";
...

{
  ...
  echo "          <tr id=\"progress\" style=\"display:none; text-align:center;\"><td colspan=\"2\"><img src=\"images/processing.gif\"></td></tr>\n";
  ...
  echo "              <td align=\"left\" width=\"15%\"><font size=\"1\" face=\"$font\" color=\"$normalfontcolor\">Giornata</font></td>\n";
...

{
  ...
  echo "          <tr id=\"progress2\" style=\"display:none; text-align:center;\"><td colspan=\"2\"><img src=\"images/processing.gif\"></td></tr>\n";
...
$giornata = getPostVar('giornata');

$description = ($giornata==0)?"Lista dei giocatori":"Voti fantagazzetta $giornata giornata";
...

{
	...
	case 'upload';
		...
		$userfile_name = ($giornata>0)?"FGG". $_POST['giornata'] .".txt":"calciatori.txt";//$userfile['name'];
...

		{
...

			{
...

				{
					...
					$message="$mess[36] <b>$userfile_name</b> $mess[37]".(($exist)?" (sovrascritto)":"");

                                        //$message="$mess[36] <b>FGG". $_POST['giornata'] ."</b> $mess[37]";
